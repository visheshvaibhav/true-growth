    ...
    <section id="work" class="py-20 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mt-12 text-center">
                <a href="/portfolio" class="inline-flex items-center justify-center px-8 py-4 text-lg font-medium text-white bg-indigo-600 rounded-full hover:bg-indigo-700 transition-colors duration-300">
                    View All Projects
                    <svg class="ml-2 w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3"/>
                    </svg>
    ...
    <section class="py-20 bg-gradient-to-b from-indigo-50 to-white relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mt-16">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 mb-16">
                        ...
                        <div class="group relative bg-white rounded-2xl p-6 hover:shadow-xl transition duration-300">
                            ...
                            <div class="relative flex items-center justify-center h-24">
                                <div class="w-32 h-12 bg-gray-200 rounded-lg flex items-center justify-center text-gray-600 font-semibold">
                                    LOGO 1
                                </div>
                            </div>
                        </div>
                ...
                <div class="relative mt-20">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6">
                        <!-- Additional Clients (Smaller Size) -->
                        {!! str_repeat('
                        <div class="group relative bg-white rounded-xl p-4 hover:shadow-lg transition duration-300">
                            ...
                            <div class="relative flex items-center justify-center h-16">
                                <div class="w-24 h-8 bg-gray-200 rounded flex items-center justify-center text-gray-600 text-sm">
                                    LOGO
                                </div>
                            </div>
                        </div>
            ...
            <div class="mt-20 grid grid-cols-2 md:grid-cols-4 gap-8">
                ...
                <div class="text-center">
                    <div class="text-4xl font-bold text-pink-600 mb-2">25+</div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-6 lg:gap-8">
                ...
                <div class="sm:col-span-1">
                    ...
                    <ul class="space-y-3 sm:space-y-4">
                        <li>
                            <a href="/services/ai-solutions" class="text-gray-600 hover:text-indigo-600 transition-colors">Enterprise AI Solutions</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="/services/cloud-services" class="text-gray-600 hover:text-indigo-600 transition-colors">Cloud Services</a>
                        </li>
                        <li>
                            <a href="/services/consulting" class="text-gray-600 hover:text-indigo-600 transition-colors">AI-Powered Growth</a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="sm:col-span-2 lg:col-span-1">
                    ...
                    <ul class="space-y-3 sm:space-y-4">
                        ...
                        <li class="flex items-center">
                            ...
                            <a href="mailto:contact@truegrowth.ai" class="text-gray-600 hover:text-indigo-600 transition-colors">contact@truegrowth.ai</a>
                        </li>
                        <li class="flex items-center">
                            <svg class="h-6 w-6 text-indigo-600 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/>
                            </svg>
                            <a href="tel:+1-555-123-4567" class="text-gray-600 hover:text-indigo-600 transition-colors">+1 (555) 123-4567</a>
                        </li>
                    </ul>
                </div>
            </div>
